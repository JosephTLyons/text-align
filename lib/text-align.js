        ...
        if ((0 < rowString.length) && (rowString.length < editor.preferredLineLength)) {
            switch (alignmentType) {
                ...
                case alignment.CENTER:
                    rowString = " ".repeat((preferredLineLength - rowString.length) / 2) + rowString;
                case alignment.RIGHT:
                    rowString = " ".repeat(preferredLineLength - rowString.length) + rowString;
                case alignment.JUSTIFY:
                    rowString = getJustifiedRow(preferredLineLength, rowString);
            }
